...
function initConfetti() {
  ...
  for (let i = 0; i < 12; i++) {
    const confettiPieceTag = document.createElement("div");
    confettiPieceTag.className = "confetti-piece";

    confettiTag.appendChild(confettiPieceTag);
  }

  document.body.appendChild(confettiTag);
}
